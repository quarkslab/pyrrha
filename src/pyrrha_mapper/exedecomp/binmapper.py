...
def find_all_call_references(f: Function, source: str) -> tuple[Location | None, dict[int, list[Location]]]:
    decl_loc = None
...
def load_program(bin_path: Path) -> Program | None:
...
#     cmd = ["ida64", f"-ONumbatJump:{function.start:#08x}", str(abs_path)]
